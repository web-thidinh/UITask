...
var isQueryEqual = function isQueryEqual(currentVal, previousVal) {
  ...
  if (currentVal.normalized && currentVal.normalizedData !== previousVal.normalizedData) {
    var currentDependencies = (0, _normalizers.getDependentKeys)(currentVal.data, currentVal.normalizedData, currentVal.usedKeys);
    var previousDependencies = (0, _normalizers.getDependentKeys)(previousVal.data, previousVal.normalizedData, previousVal.usedKeys);
...
var createCustomSelector = (0, _reselect.createSelectorCreator)(_reselect.defaultMemoize, isQueryEqual);
...
var createQuerySelector = function createQuerySelector(type, requestKey) {
  return createCustomSelector(function (state, defaultData, multiple) {
    ...
    return {
      data: normalized ? (0, _normalizers.denormalize)(getData(data, multiple, defaultData), normalizedData, usedKeys) : getData(data, multiple, defaultData),
      pending: pending,
      loading: pending > 0,
      error: error,
      pristine: pristine,
