...
const generate = async _ref2 => {
  ...
  const logWrite = (emoji, filePath, dimensions) => log(`${emoji}  ${_path.default.relative(workingPath, filePath)}` + (dimensions != null ? ` (${dimensions.width}x${dimensions.height})` : ""), true);
  ...
  if (ios) {
    ...
    if (_fsExtra.default.existsSync(projectPath)) {
      ...
      log(`✨  ${_path.default.relative(workingPath, storyboardPath)}`, true);
    } else {
